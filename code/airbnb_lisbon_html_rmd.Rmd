...
Current project aims to predict the rental price for an Airbnb property in Lisbon. Our client wants to estimate the revenue of an Airbnb apartment in Lisbon. We attempt to support their investment decision by making a prediction to give inputs to calculate the potential income. In this report, we introduce the process of the prediction step by step. For further information, please visit the linked [**GitHub**](https://github.com/zsomborh/airbnb_lisbon).
